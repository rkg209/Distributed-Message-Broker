...
public record BrokerConfig(
    int brokerId, String brokerHost, int brokerPort, int maxFrameBytes, int maxPollBytes) {
  ...
  static BrokerConfig fromEnv(java.util.function.Function<String, String> env) {
    ...
    return new BrokerConfig(brokerId, brokerHost, brokerPort, maxFrameBytes, maxPollBytes);
  }
